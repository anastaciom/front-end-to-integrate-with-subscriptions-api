...
export const Sidebar = () => {
  ...
  return (
    <aside className="w-80 h-full flex-col px-4 border-r border-divider">
      ...
      <section className="border-t border-divider h-24 flex flex-col justify-center">
        <a
          href="#"
          className="flex items-center hover:bg-secondary p-2 rounded"
        >
          Favoritos
        ...
        >
          Downloads
          {/* //TODO: ABRE UMA NOVA TELA: PARA MUDAR EMAIL, SENHA E DADOS DE DE PAGAMENTO
              E TAMBEM PODERA VER O HISTORICO DE PAGAMENTO */}
        </a>
      </section>
      <section className="py-2 border-t border-divider h-[calc(100vh_-_17rem)]">
        <h1 className="text-2xl font-medium tracking-wide mb-6 h-[4%]">News</h1>
          ...
          <ol className="relative border-l border-divider">
            ...
            <li className="space-x-6 space-y-2">
              ...
              <p className=" text-base font-normal text-gray-500 dark:text-gray-400">
                ...
                cum tenetur facilis sit perspiciatis, mollitia aliquam. Ut
                expedita aspernatur quis fugit sunt dolor, sequi animi earum
                voluptatum minus iure adipisci?
              </p>
              <a
                href="#"
